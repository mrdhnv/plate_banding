...
## Файл [materials.py](/mrdhnv/plate_banding/materials.py)
...
## Файл [plot.py](/mrdhnv/plate_banding/plot.py)

Основной файл для построения прогиба и напряжений пластины. При запуске данного файла в директории
[results](/mrdhnv/plate_banding/ANSYS/results) генерируются файлы с графиками, соответствующие примерам, заданным в файле
[materials.py](/mrdhnv/plate_banding/materials.py).

## Директория [ANSYS](/mrdhnv/plate_banding/ANSYS)
...
## Директория [others](/mrdhnv/plate_banding/others)

В данной директории собраны различные файлы.

### Файл [Дипломная_работа.pdf](/mrdhnv/plate_banding/others/Дипломная_работа.pdf)
...
### Папка [independence](/mrdhnv/plate_banding/others/independence)
...
### Папка [sigma_33](/mrdhnv/plate_banding/others/sigma_33)
...
### Файл [slider_visualisation.py](/mrdhnv/plate_banding/others/slider_visualisation.py.py)
